  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 Direccionar al aprendiz con el manejo de los tipos de mapas de textura, relacionándolo con los colores reales que se encuentran en la naturaleza
        .tarjeta.tarjeta--azul.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
              p.fw-bold.mb-0 Tipos de mapas de textura
            .col-auto
